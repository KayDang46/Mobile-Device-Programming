    ...
    let data = [
        {
            ...
            image: require('../assets/donut_1.png'),
        },
        {
            id: 1,
            name: 'Pink Donut',
            price: 20,
            description: 'Spicy tasty donut family',
            image: require('../assets/donut_2.png'),
        },
        {
            id: 2,
            name: 'Floating Donut',
            price: 30,
            description: 'Spicy tasty donut family',
            image: require('../assets/donut_3.png'),
        },
        {
            id: 3,
            name: 'Tasty Donut',
            price: 10,
            description: 'Spicy tasty donut family',
            image: require('../assets/donut_4.png'),
        },
        {
            id: 4,
            name: 'Tasty Donut',
